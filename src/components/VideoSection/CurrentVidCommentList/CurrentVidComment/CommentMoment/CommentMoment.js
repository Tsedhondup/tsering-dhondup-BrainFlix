...
const CommentMoment = (props) => {
  // TIME ELAPSE SINCE A COMMENT WAS ADDED

  const getMoment = (timestamp) => {
    // VARIBALE TO STORE TIME ELAPSE SINCE A COMMENT WAS ADDED
    let moment;
     ...
     *
     * e.g : 'TOTAL-SECONDS' VARIABLE INDICATES THE NUMBER OF SECONDS ELAPSED SINCE A COMMENT WAS ADDED
     */
  ...
  return (
    <p className="comment-text-container__moment">
      {/* INVOKING GET MOMENT-FUNCTION  */}
